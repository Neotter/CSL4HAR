...
LastEditTime: 2022-08-05 21:55:09
FilePath: \CSL4HAR\praser\embedding.py
'''
...
def parse_args():
    ...
    parser.add_argument('-p', '--pretrained_model', required=True, dest="pretrained_model_path",
    ...
    save_dir = './saved/embedding/{}@{}/{}-embed_dim{}-lr{:.0e}/'.format(
         args.augmentation, args.augment_rate*100,args.dataset, args.model_cfg.embed_dim, args.train_cfg.lr)
    ...
    if args.config_path:
        ...
        config_path = './config/praser-embedding.json'
